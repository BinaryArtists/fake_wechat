package io.flutter.plugins.fakewechat;
...
/** FakeWechatPlugin */
public class FakeWechatPlugin implements MethodCallHandler, PluginRegistry.ViewDestroyListener, IWXAPIEventHandler {
  /** Plugin registration. */
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "plugins.flutter.io/fake_wechat");
...
//  private static final String ARGUMENT_KEY_TIMESTAMP = "timestamp";
  ...
  public FakeWechatPlugin(Registrar registrar, MethodChannel channel) {
  ...
  private WechatReceiver wechatReceiver = new WechatReceiver() {
    ...
    public void handleIntent(Intent intent) {
      iwxapi.handleIntent(intent, FakeWechatPlugin.this);
    }
  };
  ...
  public void onMethodCall(MethodCall call, Result result) {
    if (METHOD_REGISTERAPP.equals(call.method)) {
      ...
      result.success(iwxapi.isWXAppSupportAPI());
